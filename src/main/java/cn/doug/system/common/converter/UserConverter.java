...
public interface UserConverter {
    ...
    @Mappings({
            @Mapping(target = "genderLabel", expression = "java(cn.doug.system.common.base.IBaseEnum.getLabelByValue(bo.getGender(), cn.doug.system.common.enums.GenderEnum.class))")
    })
