...
public class VeteranCadreImportVO implements Serializable {
   ...
   @ExcelProperty(value = "籍贯")
     ...
     * 政治面貌(数据字典'政治面貌')
     */
   @ExcelProperty(value = "政治面貌(数据字典'政治面貌')")
   ...
   @ExcelProperty(value = "常住住址")
     ...
     */
   @ExcelProperty(value = "婚姻状况(0.已婚，1.未婚，2.丧偶，3.离婚，4.再婚)")
    private String marryFlag;

    /**
     * 文化程度(调用字典)
     */
   @ExcelProperty(value = "文化程度(调用字典)")
   ...
   @ExcelProperty(value = "参加工作时间")
     ...
     * 人员类型(0.干部，1.其他)
     */
   @ExcelProperty(value = "人员类型(0.干部，1.其他)")
    private String personnelType;

    /**
     * 是否关工委老同志(0.否，1.是)
     */
   @ExcelProperty(value = "是否关工委老同志(0.否，1.是)")
    private String isCommitte;

    /**
     * 现任关工委职务(0.主任，1.常务副主任，2.副主任，3.其他)
     */
   @ExcelProperty(value = "现任关工委职务(0.主任，1.常务副主任，2.副主任，3.其他)")
   ...
   @ExcelProperty(value = "党支部信息")
     ...
     * 退/离休类型(0.退休，1.离休)
     */
   @ExcelProperty(value = "退/离休类型(0.退休，1.离休)")
   ...
   @ExcelProperty(value = "退/离休时工作职务")
     ...
     * 退/离休时职级(调用基础数据字典'级别')
     */
   @ExcelProperty(value = "退/离休时职级(调用基础数据字典'级别')")
   ...
   @ExcelProperty(value = "退/离休时间")
     ...
     */
   @ExcelProperty(value = "现享受待遇(调用基础数据字典'现享受待遇')")
    private String salary;

    /**
     * 是否为异地安置(0.否，1.是)
     */
   @ExcelProperty(value = "是否为异地安置(0.否，1.是)")
   ...
   @ExcelProperty(value = "接受安置单位电话")
     ...
     */
   @ExcelProperty(value = "健康状况(调用 26 基础数据字典'健康状况')")
   ...
   @ExcelProperty(value = "参加社团情况")
     ...
     * 是否离世(0.否，1.是)
     */
   @ExcelProperty(value = "是否离世(0.否，1.是)")
